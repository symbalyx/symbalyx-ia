...
const TABS = {
  ...
  // Livrables IA (sites, devis générés...) (V8.7)
  project_deliverables: {
    headers: [
      'id','ts','project_id','client_id','type','version','file_url',
      'generated_by','status','reviewed_by','reviewed_at',
      'cost_eur','input_tokens','output_tokens','html_size','notes'
    ],
    seed: []
  },
};
